 ...
 */
public class LuceneDocumentRanking {
	...
	public static void main(String[] args) throws IOException {
		...
		try{
			File file = new File("D:\\NEU Study Material\\Semeter 1\\IR\\Assignments\\A04\\run 6\\query4_top_100_docs.txt");
